...
const mockData = {
  nodes: [
    ...
    { id: 'service1', label: 'Service', name: 'Patient Management', consumers: 4, status: 'active' },
    { id: 'service2', label: 'Service', name: 'Disease Reference', consumers: 2, status: 'active' },
    { id: 'service3', label: 'Service', name: 'Patient Profile', consumers: 5, status: 'active' },
    { id: 'service4', label: 'Service', name: 'Diagnosis System', consumers: 6, status: 'active' },
    { id: 'service5', label: 'Service', name: 'Electronic Health Records', consumers: 4, status: 'in_development' },
    { id: 'service6', label: 'Service', name: 'Treatment Catalog', consumers: 3, status: 'in_development' },
    { id: 'service7', label: 'Service', name: 'Facility Management', consumers: 5, status: 'active' },
    { id: 'service8', label: 'Service', name: 'Bed Management', consumers: 3, status: 'active' },
    { id: 'service9', label: 'Service', name: 'Nutrition Management', consumers: 1, status: 'in_development' },
    { id: 'service10', label: 'Service', name: 'Allergen Repository', consumers: 1, status: 'vapourware' },
    { id: 'service11', label: 'Service', name: 'Meal Ordering', consumers: 1, status: 'vapourware' },
    { id: 'service12', label: 'Service', name: 'Pharmacy System', consumers: 2, status: 'active' },
    { id: 'service13', label: 'Service', name: 'Equipment Management', consumers: 3, status: 'in_development' },
    { id: 'service14', label: 'Service', name: 'Vital Signs Monitoring', consumers: 1, status: 'active' },
    { id: 'service15', label: 'Service', name: 'Blood Pressure Monitoring', consumers: 1},
    { id: 'service16', label: 'Service', name: 'Temperature Monitoring', consumers: 1, status: 'active' },
    { id: 'service17', label: 'Service', name: 'Visual Monitoring', consumers: 1, status: 'vapourware' },
    { id: 'service18', label: 'Service', name: 'Alert System', consumers: 1, status: 'in_development' },
    { id: 'service19', label: 'Service', name: 'Staff Scheduling', consumers: 4, status: 'active' },
    { id: 'service20', label: 'Service', name: 'Notification System', consumers: 2 },
    { id: 'service21', label: 'Service', name: 'Shift Management', consumers: 2, status: 'active' },
    { id: 'service22', label: 'Service', name: 'Calendar System', consumers: 5, status: 'active' },
    { id: 'service23', label: 'Service', name: 'Staff Directory', consumers: 4, status: 'active' },
    { id: 'service24', label: 'Service', name: 'Housekeeping Services', consumers: 2, status: 'vapourware' },
    { id: 'service25', label: 'Service', name: 'Billing System', consumers: 2, status: 'active' },
  ],
  links: [
