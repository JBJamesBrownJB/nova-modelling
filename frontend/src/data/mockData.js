...
const mockData = {
  nodes: [
    ...
    { id: 'service10', label: 'Service', name: 'Allergen Repository', consumers: 1, status: 'not_built' },
    { id: 'service11', label: 'Service', name: 'Meal Ordering', consumers: 1, status: 'not_built' },
    ...
    { id: 'service17', label: 'Service', name: 'Visual Monitoring', consumers: 1, status: 'not_built' },
    ...
    { id: 'service24', label: 'Service', name: 'Housekeeping Services', consumers: 2, status: 'not_built' },
