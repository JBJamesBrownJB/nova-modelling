...
const mockData = {
  nodes: [
    // JTBD Nodes
    { id: 'jtbd1', label: 'JTBD', name: 'Diagnose Patient', progress: 0 },
    { id: 'jtbd2', label: 'JTBD', name: 'Re-diagnose patient', progress: 0 },
    { id: 'jtbd3', label: 'JTBD', name: 'Find Patient', progress: 0 },
    { id: 'jtbd4', label: 'JTBD', name: 'Prescribe treatment', progress: 0 },
    { id: 'jtbd5', label: 'JTBD', name: 'Assign bed', progress: 0 },
    { id: 'jtbd6', label: 'JTBD', name: 'Choose Meal', progress: 0 },
    { id: 'jtbd7', label: 'JTBD', name: 'Discharge Patient', progress: 0 },
    { id: 'jtbd8', label: 'JTBD', name: 'Treat Patient', progress: 0 },
    { id: 'jtbd9', label: 'JTBD', name: 'Monitor Patient', progress: 0 },
    { id: 'jtbd10', label: 'JTBD', name: 'Assign shift', progress: 0 },
    { id: 'jtbd11', label: 'JTBD', name: 'View on duty staff', progress: 0 },
    ...
    { id: 'jtbd16', label: 'JTBD', name: 'Order Medication', progress: 0 },
    { id: 'jtbd17', label: 'JTBD', name: 'Perform Lab Test', progress: 0 },
    { id: 'jtbd18', label: 'JTBD', name: 'Review Lab Results', progress: 0 },
    { id: 'jtbd19', label: 'JTBD', name: 'Manage Patient Records', progress: 0 },
    { id: 'jtbd20', label: 'JTBD', name: 'Triage Emergency', progress: 0 },
    { id: 'jtbd21', label: 'JTBD', name: 'Transfer Patient', progress: 0 },
    { id: 'jtbd22', label: 'JTBD', name: 'Check In Patient', progress: 0 },
    { id: 'jtbd23', label: 'JTBD', name: 'Provide Visitor Pass', progress: 0 },
    { id: 'jtbd24', label: 'JTBD', name: 'Conduct Rounds', progress: 0 },
    { id: 'jtbd25', label: 'JTBD', name: 'Administer Medication', progress: 0 },
    { id: 'jtbd26', label: 'JTBD', name: 'Process Insurance', progress: 0 },
    { id: 'jtbd27', label: 'JTBD', name: 'Handle Incident Report', progress: 0 },
    { id: 'jtbd28', label: 'JTBD', name: 'Manage Allergies', progress: 0 },
    { id: 'jtbd29', label: 'JTBD', name: 'Update Medical History', progress: 0 },
    { id: 'jtbd30', label: 'JTBD', name: 'Process Referral', progress: 0 },
    { id: 'jtbd31', label: 'JTBD', name: 'Sanitize Equipment', progress: 0 },
    { id: 'jtbd32', label: 'JTBD', name: 'Create Care Plan', progress: 0 },
    { id: 'jtbd33', label: 'JTBD', name: 'Document Patient Encounter', progress: 0 },
    { id: 'jtbd34', label: 'JTBD', name: 'Coordinate Follow-up', progress: 0 },
